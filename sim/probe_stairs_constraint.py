"""Probe: constraint-based angle lock created after handoff."""
import math
...
def run():
    ...
    # Ghost body (created but not constrained yet)
    ...
    while t < 30.0:
        ...
        if locked:
            # Update ghost x to follow body (allows body to translate)
