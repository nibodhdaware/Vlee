"""Probe: rear jack lift with angle lock (simulates hydraulic jack holding fixed length)."""
import math
    ...
    while t < 30.0:
        ...
        if lifting and not angle_locked:
            ...
            if err > 0:
                ...
                # Reached target - lock pitch with a constraint
                angle_locked = True
            ...
            # Just hold with small force to compensate for any drift
